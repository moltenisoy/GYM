...
from shared.constants import (
    ENDPOINT_AUTORIZAR,
    ENDPOINT_VALIDAR_SYNC,
    ENDPOINT_SINCRONIZAR_DATOS,
    ENDPOINT_ENVIAR_MENSAJE,
    ENDPOINT_OBTENER_MENSAJES,
    ENDPOINT_MARCAR_LEIDO,
    ENDPOINT_CONTAR_NO_LEIDOS,
    ENDPOINT_ENVIAR_CHAT,
    ENDPOINT_OBTENER_CHAT,
    STATUS_APPROVED,
    STATUS_SYNC_SUCCESS,
    ERROR_CONNECTION,
    ERROR_TIMEOUT,
...
LOCAL_DATA_DIR = settings.LOCAL_DATA_DIR if os.path.isabs(settings.LOCAL_DATA_DIR) else os.path.join(os.path.dirname(__file__), settings.LOCAL_DATA_DIR)
